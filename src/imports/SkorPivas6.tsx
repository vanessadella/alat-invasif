import svgPaths from "./svg-fbaoixb5k2";
...
function Frame8() {
  return (
    <div className="absolute content-stretch flex flex-col gap-[8px] items-start left-[20px] top-[232px] w-[324px]">
      ...
      <div className="content-stretch flex gap-[8px] items-center relative shrink-0 w-full" data-name="New - Checkbox">
        <Unchecked />
        <div className="flex flex-col font-['Roboto:Regular',sans-serif] font-normal justify-center leading-[0] relative shrink-0 text-[#555] text-[14px] text-justify whitespace-nowrap" style={{ fontVariationSettings: "'wdth' 100" }}>
          <p className="leading-[20px]">Lepaskan kanula</p>
        </div>
      </div>
      <div className="content-stretch flex gap-[8px] items-center relative shrink-0 w-full" data-name="New - Checkbox">
        <Unchecked1 />
        <div className="flex flex-[1_0_0] flex-col font-['Roboto:Regular',sans-serif] font-normal justify-center leading-[0] min-h-px min-w-px relative text-[#555] text-[14px] text-justify" style={{ fontVariationSettings: "'wdth' 100" }}>
          <p className="leading-[20px]">{`Lakukan pengambilan sampel mikrobiologi → sampel pus `}</p>
        </div>
      </div>
      <div className="content-stretch flex gap-[8px] items-center relative shrink-0 w-full" data-name="New - Checkbox">
        <Checked />
        <div className="flex flex-col font-['Roboto:Regular',sans-serif] font-normal justify-center leading-[0] relative shrink-0 text-[#555] text-[14px] text-justify whitespace-nowrap" style={{ fontVariationSettings: "'wdth' 100" }}>
          <p className="leading-[20px]">{`Pindahkan kanula bila masih diperlukan `}</p>
        </div>
      </div>
      <div className="content-stretch flex gap-[8px] items-center relative shrink-0 w-full" data-name="New - Checkbox">
        <Unchecked2 />
        <div className="flex flex-[1_0_0] flex-col font-['Roboto:Regular',sans-serif] font-normal justify-center leading-[0] min-h-px min-w-px relative text-[#555] text-[14px] text-justify" style={{ fontVariationSettings: "'wdth' 100" }}>
          <p className="leading-[20px]">{`Kolaborasi dengan dokter sesuai hasil kultur untuk pengobatan `}</p>
        </div>
      </div>
      <div className="content-stretch flex gap-[8px] items-center relative shrink-0 w-full" data-name="New - Checkbox">
        <Unchecked3 />
        <div className="flex flex-col font-['Roboto:Regular',sans-serif] font-normal justify-center leading-[0] relative shrink-0 text-[#555] text-[14px] text-justify whitespace-nowrap" style={{ fontVariationSettings: "'wdth' 100" }}>
          <p className="leading-[20px]">Lakukan Perawatan Phlebitis</p>
        </div>
      </div>
      <div className="content-stretch flex gap-[8px] items-center relative shrink-0 w-full" data-name="New - Checkbox">
        <Checked1 />
      ...
      <div className="content-stretch flex gap-[8px] items-center relative shrink-0 w-full" data-name="New - Checkbox">
        <Unchecked4 />
        <div className="flex flex-col font-['Roboto:Regular',sans-serif] font-normal justify-center leading-[0] relative shrink-0 text-[#555] text-[14px] text-justify whitespace-nowrap" style={{ fontVariationSettings: "'wdth' 100" }}>
          <p className="leading-[20px]">Dokumentasikan dan buat Incident Report</p>
        </div>
      </div>
    </div>
  );
...
export default function SkorPivas() {
  return (
    <div className="bg-[#f4f3f2] relative size-full" data-name="Skor PIVAS 6">
